...
<%@ attribute name="language" 	required="false" type="com.ab.profit.entity.Language" %>
		...
		<div class="row">
			<div class="col-xs-12 col-md-3 form-group">
				<div class="row">
					...
					<c:if test="${language != null }"><profit:form-has-error path="items[${index }].name"/></c:if>
			...
			<div class="col-xs-12 col-md-9">
				...
				<div style="padding: 0 30px;">
					<profit:form-input-slider index="${index }" value="${language != null ? language.level.sliderIntValue : 4}" />
				</div>
			</div>
		</div>
	</div>
