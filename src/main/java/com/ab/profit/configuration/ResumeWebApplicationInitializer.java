...
import com.ab.profit.component.impl.ApplicationListener;
import com.ab.profit.component.impl.DebugFilter;
import com.ab.profit.component.impl.ErrorHandler;

// Hier werden alle Klassen skaniert,Cookies werden hinzugefügt
//Spring getBean wird bentzt
//Filter werden registriert
...
public class ResumeWebApplicationInitializer implements WebApplicationInitializer 
{
	...
	private WebApplicationContext createWebApplicationContext(ServletContext container) 
	{
		...
		ctx.scan("com.ab.profit.configuration");
