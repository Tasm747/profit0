	...
	<div class="panel panel-default profile-item">
		<div class="media panel-body">
			<div class="media-left media-top">
				...
				<a href="/${profile.uid }" class="btn btn-primary visible-xs-block" style="margin-top: 15px;">Details</a>
			</div>
			<div class="media-body search-result-item">
				<a href="/${profile.uid }" class="btn btn-primary pull-right hidden-xs">Details</a>
